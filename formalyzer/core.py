...
# %% auto 0
__all__ = ['read_recc_info', 'read_urls_file', 'read_pdf_text', 'scrape_form_fields', 'get_field_mappings', 'get_element_info',
           'should_skip', 'fill_element', 'fill_form', 'upload_recommendation', 'process_url', 'read_info',
           'setup_browser', 'run_formalyzer', 'main']
...
async def should_skip(elem, tag, input_type, skip_prefilled) -> bool:
    "should we skip over this element (not fill it in)?"
