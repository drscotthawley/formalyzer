...
# %% auto 0
__all__ = ['read_text_file', 'read_urls_file', 'read_pdf_text', 'scrape_form_fields_old', 'scrape_form_fields', 'trim_fields',
...
def scrape_form_fields(html: str) -> list[dict]:
    ...
    fields.extend(_group_radio_buttons(soup).values())
    return fields
